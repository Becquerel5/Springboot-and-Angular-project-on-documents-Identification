...
export class Referencedocument { 
    ...
    firstName!: string;
    dateOfBirth!: Date;
    gender!: Referencedocument.GenderEnum;
    profession!: string;
    nameOfFather!: string;  
    nameOfMother!: string;
    deliveryDate!: Date;
    expirationDate!: Date;
    address!: string;
    statusTreatmentSystemeList!: Referencedocument.StatusTreatmentSystemeListEnum;
    statusInTreatment!: Referencedocument.StatusInTreatmentEnum;
    withdrawalDate!: Date;
}
export namespace Referencedocument {
