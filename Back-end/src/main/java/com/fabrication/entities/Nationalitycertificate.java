...
@Entity
@DiscriminatorValue("NATIOCERTIFI")
@Builder
public class Nationalitycertificate extends Additionaldocument {

    public Nationalitycertificate() {
    }

    public Nationalitycertificate(Long idAdditionalDocument, @NotBlank() String pathDocumentImage, Date dateAdded, Agent agent, Client client, Referencedocument referenceDocument) {
