...
@Entity
@DiscriminatorValue("LOSTCERTIF")
@Builder
public class Lostcertificate extends Additionaldocument {

    public Lostcertificate() {
    }

    public Lostcertificate(Long idAdditionalDocument, @NotBlank() String pathDocumentImage, Date dateAdded, Agent agent, Client client, Referencedocument referenceDocument) {
